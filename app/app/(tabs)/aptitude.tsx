...
export default function AptitudeScreen() {
  ...
  const handleStartQuiz = async () => {
    try {
      console.log('Starting quiz with category: aptitude, count:', selectedCount);
      ...
      dispatch(startNewQuiz({ category: 'Aptitude', questions }));
      router.push('/quiz-exam');
    } catch (error: any) {
      console.error('Quiz start error:', error);
      Alert.alert('Error', `Failed to start quiz: ${error?.message || 'Please check your internet connection and try again.'}`);
    }
  };
      ...
      >
        <View style={styles.header}>
          ...
          <ThemedText style={styles.headerSubtitle}>
            Test your quantitative and logical reasoning skills
          </ThemedText>
        </View>
        <View style={styles.infoCard}>
          ...
          <ThemedText style={styles.infoText}>
            ...
            • Questions cover various aptitude topics{'\n'}
